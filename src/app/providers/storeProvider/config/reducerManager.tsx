...
// import { IStateSchema, KeysOfStateSchema } from './IStateSchema';
...
//   let keysToRemove: Array<KeysOfStateSchema> = [];
...
//     add: (key: KeysOfStateSchema, reducer: Reducer) => {
//       if (!key || reducers[key]) {
//         return;
//       }
